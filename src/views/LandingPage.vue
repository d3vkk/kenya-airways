<template>
  <div>
    ...
    <div class="flex flex-row items-center justify-center my-8">
      <form @submit.prevent="searchFlight()" class="p-2 bg-white rounded-lg shadow-lg">
        <div class="flex flex-row">
          <div class="w-1/3 p-2 mt-4 mb-4">
            <div class="mb-2">From</div>
            <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none" type="text" autocomplete required v-model="fromLocation" />
          </div>
          <div class="w-1/3 p-2 mt-4 mb-4">
            <div class="mb-2">To</div>
            <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none" type="text" autocomplete required v-model="toLocation" />
          </div>
          <div class="w-1/3 p-2 mt-4 mb-4">
            <div class="mb-2">Depart</div>
            <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none" type="time" autocomplete required v-model="departTime" />
          </div>
        </div>
        <div class="flex flex-row">
          <div class="w-1/3 p-2 mt-4 mb-4">
