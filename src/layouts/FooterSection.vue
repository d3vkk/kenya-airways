  ...
  <footer>
    ...
    >
      ...
      <div class="w-full pb-6 md:w-1/4 lg:w-1/4">
        ...
        <div class="pb-1">
          <a href="mailto:contact@kenyaairways.com">Email&nbsp;Us</a>
        </div>
      ...
      <div class="w-full pb-6 md:w-1/4 lg:w-1/4">
        ...
        <div class="pb-1">
          <a
            href="https://twitter.com/KenyaAirways"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <div class="pb-1">
          <a
            href="https://www.instagram.com/officialkenyaairways/"
            target="_blank"
            rel="noreferrer"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <div class="pb-1">
          <a
            href="https://www.linkedin.com/company/kenya-airways"
            target="_blank"
            rel="noreferrer"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
    ...
    <div id="second-footer" class="flex flex-row justify-center p-3">
      <div class="pb-1">
        <router-link to="/">
          <img
            src="img/logo.svg"
